      ...
      <div className="w-full flex items-center justify-center">
        <ProjectContainer>
          ...
          <ProjectChallangeApproach
            challange="Crafting a digital showcase that truly captures the essence of Theng photography was our primary challenge. We needed to create a platform that not only displayed the images beautifully but also reflected the photographer's unique style and vision. The website had to strike a delicate balance between minimalism and functionality, ensuring that the photographs remained the focal point while providing an intuitive and engaging user experience."
            approach={[
